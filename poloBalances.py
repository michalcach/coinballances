...
KEY = bytes("lrRqcPnCgvcZhkyWbVm54GT8Qg3qzmB1DJbs5cy5Hrr", encoding='utf-8')
SECRET = bytes("2a3mlAe7ttqC7KKTnYHhNjBfLV1g0g2eS9RnnESHqRz", encoding='utf-8')

p = Poloniex()
p.key = "H0A7AS6K-WFZBYV87-4JUZ3FN0-QXFGJVAQ"
p.secret = "aaad07c51c2eef702827687657ac04f91e9b38b2afb13f39fbc5fcb0e8720612f0ea569e14277ecafdfecf4a905a5c7022c6f733122bf3b4754797058dedc271"

print(p.returnCompleteBalances()['BTC'])
